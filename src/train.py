...
if __name__ == '__main__':
    ...
    model = UNet_3D(num_classes=len(ALL_CLASSES)).to(device)
    print(model)
    ...
    train_dataset = torch.load('../input/train_dataset')
    valid_dataset = torch.load('../input/valid_dataset')
    train_dataloader = torch.load("../input/train_dataloader")
    valid_dataloader = torch.load("../input/valid_dataloader")
